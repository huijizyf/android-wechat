package com.donute.tencenthelper.chatui.widget;
...
import com.donute.tencenthelper.chatui.util.AudioRecoderUtils;
import com.donute.tencenthelper.chatui.util.PopupWindowFactory;
...
public class EmotionInputDetector {
    ...
    public EmotionInputDetector bindToSendButton(View sendButton) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                messageInfo.setMsgType(MsgType.WORDS);
    ...
    public EmotionInputDetector build() {
        ...
        mAudioRecoderUtils.setOnAudioStatusUpdateListener(new AudioRecoderUtils.OnAudioStatusUpdateListener() {
            ...
            public void onStop(long time, String filePath) {
                ...
                messageInfo.setMsgType(MsgType.VOICE);
                EventBus.getDefault().post(messageInfo);
            }
    ...
    private void showEmotionLayout() {
        ...
        hideSoftInput();
        mEmotionLayout.getLayoutParams().height = MainApp.screenHeight/3;
